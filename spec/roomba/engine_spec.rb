...
describe "Validate engine" do
  ...
  specify "out of table" do
    ...
    edges.each do |edge|
      ...
      engine.on.off.should eq([edge])
    end
  end

  specify "place out of table" do
    ...
    places.each do |place|
      ...
      engine.on.off.should eq(["0,0,SOUTH"])
    end
  end
end